...
PAIR_CATEGORIES = [
    ...
    },
    {
        ...
        "ko": (
            "한 장에 하나만",
            "넘기게 만드는 카드의 리듬",
            # 마침표·쉼표에서 끊는다. 카드는 한 번에 잡히는 덩어리라야 넘어간다.
            "카드뉴스는 손가락이 결정합니다.\n"
            "한 장에 문장을 욱여넣으면 넘기기 전에 지치고,\n"
            "너무 비우면 다음 장을 눌러야 할 이유가 사라집니다.",
        ),
        "en": (
            "One Idea Per Card",
    ...
    },
    {
        ...
        "ko": (
            "고맙습니다",
            "오래 기억하겠습니다",
            # 마침표·쉼표에서 끊는다. 손글씨는 줄이 끊기는 자리가 곧 호흡이다.
            "어떤 문장은 내용보다 필적이 먼저 도착합니다.\n"
            "한 번 읽고 오래 간직하는 글에서는,\n"
            "반듯한 서체보다 조금 기울고 흔들리는 획이 더 오래 남습니다.",
        ),
        "en": (
            "Thank You",
