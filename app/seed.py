...
# ═══════════════════════════════════════════════════════════
# v2 — 폰트 목록 개편. 우아한세리프·국립중앙박물관문화재단클래식을 빼고
# ZEN SERIF와 본문용 고딕 4종을 넣었으며, 1위를 고운바탕으로 바꿨다.
# 키를 올리면 이 함수가 통째로 다시 도는데, 제목·부제·기준·활용법·문구는
# 지금 운영에 올라간 값과 같은 내용이라 실제로 바뀌는 것은 폰트 목록뿐이다.
LUXURY_HUB_MIGRATION_KEY = "luxury_hub_migration_v2"
...
# 다만 명조만으로는 브랜드가 굴러가지 않는다. 웹·앱·안내문을 받칠 본문 고딕을
# 6종 섞어 두었다.
#
...
# 고딕은 굵기 가족이 깊은 것으로만 골랐다 — 브랜드 본문은 제목·소제목·주석까지
# 위계를 나눠야 하는데, 굵기가 하나면 그걸 색으로 때워야 한다.
_LUXURY_MORE = [
    (33, "마루부리"),
    (27, "더잠실체"),              # 고딕 6굵기 · 로고에도 쓰는 서체
    (61, "에스코어드림"),           # 고딕 9굵기
    (72, "을유1945"),
    (22, "나눔명조"),
    (181, "IBM Plex Sans KR"),   # 고딕 9굵기 · 다국어
    (8, "KoPub바탕"),
    (194, "ZEN SERIF"),
    (182, "함렛"),
    (101, "프리텐다드"),            # 고딕 9굵기
