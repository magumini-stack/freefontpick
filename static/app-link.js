 ...
 * 스토어 주소는 왜 여기 있나
 * ------------------------
 * 배너가 두 군데(상세 사이드바·디자이너 모달)에 있어서, 마크업에 주소를
 * 두 번 적으면 앱이 늘거나 주소가 바뀔 때 반드시 한 곳이 남는다. 마크업에는
 ...
 * 자동광고 앵커 광고와 자리를 다툰다. 홈에 있던 하단 띠(.fbx)가 그 문제로
 * 스크롤 뒤에 올라오는 방식까지 갔다가, 2026-09 에 갤러리 첫 칸 카드로
 * 바뀌며 걷어졌다.
